...
# Apache 2 & NGINX Configuration for Reverse Proxy
1. Apache2 Setup - https://stackoverflow.com/questions/8541182/apache-redirect-to-another-port
2. NGINX Config
...
```
Below is server config, need to create a file in conf.d/site1.conf
```
server {
